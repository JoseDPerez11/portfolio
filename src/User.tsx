...
const Info={
    name: "Jose D. Pérez",
    stack: ["Software Enginner", "Full Stack Web Developer", "Competitive Programmer", "Freelancer", "Open Source Contributor"],
...
const SkillInfo = [
    {
        title: "Frontend",
        skills: ["HTML", "CSS", "JavaScript", "React JS", "Angular", "Tailwind CSS", "Material UI", "Bootstrap"
        ]
    },
    {
        title: "Backend",
